...
{/*cambio de prueba*/}
            <div className="container grid-footer">
                <div id="w-node-e224ee31-0292-9c87-8851-6edd6b8989e9-6b8989e7" className="footer_column">
                    ...
                    <div className="form-block w-form">
                        <form id="email-form" name="email-form" data-name="Email Form" method="get" className="flex-vertical-stretch-gap_16px" data-wf-page-id="6400d829514500b4d3d1eb7f" data-wf-element-id="e224ee31-0292-9c87-8851-6edd6b8989ed">
                            ...
                            <a data-w-id="e224ee31-0292-9c87-8851-6edd6b8989ef" href="#" className="primary_button w-inline-block">
                ...
                <div id="w-node-e224ee31-0292-9c87-8851-6edd6b8989f6-6b8989e7" className="footer_column">
                ...
                <div id="w-node-e224ee31-0292-9c87-8851-6edd6b898a12-6b8989e7" className="footer_column">
                    ...
                    <div className="footer_colum-wrap_links">
                        ...
                        <a data-w-id="e224ee31-0292-9c87-8851-6edd6b898a21" href="#" className="links w-inline-block">
                            <div className="link-text">Wedding &amp;Event Decor</div>
                            <div className="link-text">Wedding &amp;Event Decor</div>
                        </a>
                    </div>
                </div>
                <div id="w-node-e224ee31-0292-9c87-8851-6edd6b898a22-6b8989e7" className="footer_column">
                    ...
                    <div className="footer_colum-wrap_links margin-bottom-24px">
                        ...
                        <a data-w-id="e224ee31-0292-9c87-8851-6edd6b898a27" href="#" className="links w-inline-block">
